...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        private void whatPlayerMustDoInStartConversation()
        {
        ...
        private void whatPlayerMustDoInEndConversation()
        {
            _playerHealth.setInmortalModeFalse();
        ...
        {
            whatPlayerMustDoInStartConversation();
        ...
        public void EndConversation()
        {
            ...
            if (OnConversationEnded != null)
                ...
                whatPlayerMustDoInEndConversation();
        }
